PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.boot.hardware.revision=wal_bd-V1 \
    ...
    ro.config.default_message0=Rhea.ogg \
    ro.config.default_message1=Rhea.ogg \
    ro.config.default_message=Rhea.ogg \
    ro.config.low_ram=true \
    ro.config.notification_sound=Rhea.ogg \
    ro.config.ringtone0=Lattice.ogg \
    ro.config.ringtone1=Lattice.ogg \
    ro.config.ringtone=Lattice.ogg \
    ro.config.ringtone_2=Lattice.ogg \
    ro.control_privapp_permissions=log \
    ro.custom.build.version=Primo_D9_S04_19112018 \
    ro.feature.storage.dialog=true \
    ro.ge2.mode=gps_beidou \
    ro.hardware.keystore=sprdtrusty \
    ro.hotspot.enabled=1 \
    ro.internal.build.version=K101BG_8.1_WAL_BD_BR1_05 \
    ro.keybox.id.value=Primo_D9 \
    ...
    ro.project=wal_bd \
    ro.pt.remove_lang_follow_sim=true \
